...
import 'package:student_management_system/file_handling/setting_page.dart';
...
class UtilFunctions {
  ...
  static Future<bool> createFile(
      String pathToSave, String fileName, String fileExtension) async {
    bool hasPermission = await prepareStorage();
    if (!hasPermission) {
      return false;
    }
  ...
  static void showFileCreatedSnackBar(
